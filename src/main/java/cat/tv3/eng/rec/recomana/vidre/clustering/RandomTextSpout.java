...
public class RandomTextSpout extends BaseRichSpout{
    ...
    public void nextTuple() { 
    	if(i==0){	  
	    	...
	    	_collector.emit(new Values("id-politica-1",vocabulary_politica_1));	    	
    	}
    	else if(i==1){
    		i++;
    		...
    		_collector.emit(new Values("id-politica-2",vocabulary_politica_2));	    	
    	}
    	else if(i==2){
    		i++;
    		...
    		_collector.emit(new Values("id-oci_cultura",vocabulary_oci_cultura));	   		
    		...
    		_collector.emit(new Values("id-economia_1",vocabulary_economia_1));	   	
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {       
        declarer.declare(new Fields("id_noticia","distr_prob_text")); 
	}
}
